...
| `/calendar` | Календарь (текущий месяц + месяцы до конца года) с отпусками и поездками |
| `/events` | Список мероприятий с поддержкой переноса строк в описании |
| `/events/[id]` | Детали мероприятия (место и маршрут как ссылки, перенос строк в описании) |
