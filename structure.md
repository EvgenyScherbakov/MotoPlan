...
│   │   │   ├── calendar/
│   │   │   │   └── page.tsx          # Календарь на 3 месяца
│   │   │   ├── events/
│   │   │   │   ├── page.tsx          # Список мероприятий
│   │   │   │   ├── EventsContent.tsx # Основной компонент событий
│   │   │   │   └── [id]/
│   │   │   │       └── page.tsx      # Детали мероприятия
│   │   │   ├── profile/
...
| `/calendar` | `calendar/page.tsx` | Календарь на 3 месяца с событиями и отпусками |
| `/events` | `events/page.tsx` | Список мероприятий + управление отпусками |
| `/events/[id]` | `events/[id]/page.tsx` | Детальная карточка мероприятия |
